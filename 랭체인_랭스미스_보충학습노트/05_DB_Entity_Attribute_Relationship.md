...
영어 관계명으로 `places`, `included_in`처럼 쓰는 예시도 많지만, 학생용 자료에서는 `주문한다`, `주문에 포함된다`처럼 문장으로 읽히는 표현이 더 이해하기 쉽습니다.
...
[이전 글](04_DB_데이터를_저장하고_꺼내쓰는_공간.md) · [다음 글: SQL DB와 NoSQL DB](06_DB_SQL_DB와_NoSQL_DB.md)
